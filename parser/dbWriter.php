...
// Переменные, определяемые в начале, зависящие от времени и турнира. Также нужно в parsingStarter проследить за правльностью адреса страницы на championat.com
