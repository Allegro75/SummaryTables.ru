...
// Насколько помню, это файл для первого опыта создания таблиц через php, через tablePagesMaker. Файл содержит данные, заточенные на скорейший вывод страницы с 12 клубами. 
// Файл предназначается (насколько помню) для удаления в момент, когда практика создания таюлиц через php будет отлажена.
...
за победу в других еврокубках - 4 очка; за выход в финал - 3; выход в 1/2 финала - 2; выход в 1/4 финала - 1\">
                    <a href=\"range.html\">
                        <span class=\"captions__explanation_circle\">&#8226;</span>
                        <span class=\"captions__explanation_larger\">12</span> лучших клубов
                        <span class=\"captions__explanation_circle\">&#8226;</span>
                    </a>
                </p>
