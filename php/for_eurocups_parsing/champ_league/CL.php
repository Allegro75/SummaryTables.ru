...
<?php
// Переменные, определяемые в начале, зависящие от времени и турнира. Дополнительно, возможно понадобится определить в functions $matchDate ("рыба" даты проведения будущих матчей в группах) и $orderedClubs здесь
...
$futureMatchesStage = '1/8 финала'; // Будущая стадия для показа
$showFutureMatchesClause = "AND (`score` != '' OR `tourneyStage` = '{$futureMatchesStage}')"; // для того, чтобы учитывать будущие несыгранные матчи в незавершённых турнирах
        ...
        <main>
            ...
            <section class="captions">
                ...
                <p class="captions__explanation">
                    Учтены матчи до <?=$lastRecordedMatchDate?> включительно
                </p>                
            </section>
            ...
            <div class="tourney">
                ...
                if ($tourFinalYear >= 2004) {
                    ...
                    // Пишем следующую стадию и дополняем массив клубов:
                    if (($tourFinalYear >= 2023) && ( getStageMatches($matches, '1/16 финала') )) {
                ...
                // Пишем следующую стадию и дополняем массив клубов:
                if (($tourFinalYear <= 2021) &&  (getStageMatches($matches, '1/16 финала'))) {
                    $orderedClubs = writeMatchesByStage('1/16 финала', $matches, $orderedClubs, $clubs, $imagesList);
                }
