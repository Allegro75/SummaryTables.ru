...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const logosToLightInTables = document.querySelectorAll(`${queryPart}Zen.png'], ${queryPart}Mar.png'], ${queryPart}Nan.png'], ${queryPart}And_dark.png'], ${queryPart}DyK.png'], ${queryPart}Mon.png'], ${queryPart}Mlm.png'], ${queryPart}RSo.png'], ${queryPart}RaW.png'], ${queryPart}AuW.png']`);
