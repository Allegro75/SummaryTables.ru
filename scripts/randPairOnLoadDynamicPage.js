...
// То же, что и randPairOnLoad.js (возможное открытие окна со случайной парой при загрузке страницы), но с ориентацией на динамическую (php) страницу с данными об истории матчей пары 
